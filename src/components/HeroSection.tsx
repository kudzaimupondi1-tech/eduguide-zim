  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-hero-gradient pt-16">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-primary/50 blur-3xl" />
      </div>
      ...
      <div className="absolute top-40 right-[20%] animate-float delay-300">
        <div className="w-14 h-14 rounded-xl bg-primary/10 backdrop-blur-sm flex items-center justify-center">
          <Target className="w-7 h-7 text-primary-foreground/70" />
        </div>
      </div>
